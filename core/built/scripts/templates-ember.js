...
function program1(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n                    ");
  stack1 = helpers['if'].call(depth0, "session.user.image", {hash:{},hashTypes:{},hashContexts:{},inverse:self.program(4, program4, data),fn:self.program(2, program2, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                    <span class=\"name\">");
...
function program6(depth0,data) {
  ...
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(7, program7, data),contexts:[depth0,depth0],types:["STRING","ID"],data:data},helper ? helper.call(depth0, "settings.users.user", "session.user.slug", options) : helperMissing.call(depth0, "link-to", "settings.users.user", "session.user.slug", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</li>\n                        <li class=\"divider\"></li>\n                        <li class=\"usermenu-help\"><a href=\"http://support.ghost.org/\">Help / Support</a></li>\n                        <li class=\"divider\"></li>\n                        <li class=\"usermenu-signout\"><a ");
...
function program1(depth0,data) {
  ...
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
    'data-select-text': ("selectedRole.name")
  ...
  },hashTypes:{'content': "ID",'id': "STRING",'optionValuePath': "STRING",'optionLabelPath': "STRING",'name': "STRING",'value': "ID",'selection': "ID"},hashContexts:{'content': depth0,'id': depth0,'optionValuePath': depth0,'optionLabelPath': depth0,'name': depth0,'value': depth0,'selection': depth0},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push("\n                </span>\n            </div>\n\n        </fieldset>\n\n");
  return buffer;
  }
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("\n                </td>\n            </tr>\n            <tr class=\"post-setting\">\n                <td class=\"post-setting-label\">\n		    <label for=\"post-setting-author\">Author</label>\n		</td>\n		<td class=\"post-setting-field\">\n		    <span class=\"author-select-wrapper\" ");
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
    'data-select-text': ("selectedAuthor.name")
  },hashTypes:{'data-select-text': "ID"},hashContexts:{'data-select-text': depth0},contexts:[],types:[],data:data})));
  data.buffer.push(">\n		       ");
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "Ember.Select", {hash:{
...
function program1(depth0,data) {
  ...
  data.buffer.push("\n            ");
  stack1 = helpers['if'].call(depth0, "showApps", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </ul>\n    </nav>\n</aside>\n\n");
  stack1 = helpers._triageMustache.call(depth0, "outlet", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program5(depth0,data) {
  ...
  var buffer = '';
  data.buffer.push("\n                    <button class=\"button-add js-modal-logo\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "openModal", "upload", "", "logo", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0,depth0,depth0,depth0],types:["STRING","STRING","ID","STRING"],data:data})));
...
function program9(depth0,data) {
  ...
  var buffer = '';
  data.buffer.push("\n                    <button class=\"button-add js-modal-cover\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "openModal", "upload", "", "cover", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0,depth0,depth0,depth0],types:["STRING","STRING","ID","STRING"],data:data})));
  data.buffer.push(">Upload Image</button>\n                ");
  return buffer;
  }
...
function program6(depth0,data) {
  ...
  },hashTypes:{'class': "STRING"},hashContexts:{'class': depth0},inverse:self.noop,fn:self.program(7, program7, data),contexts:[depth0,depth0],types:["STRING","ID"],data:data},helper ? helper.call(depth0, "settings.users.user", "", options) : helperMissing.call(depth0, "link-to", "settings.users.user", "", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        ");
  return buffer;
  }
function program7(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, "invitedUsers", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program3(depth0,data) {
  ...
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{
    ...
    'tagName': ("button")
  },hashTypes:{'class': "STRING",'tagName': "STRING"},hashContexts:{'class': depth0,'tagName': depth0},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "settings.users", options) : helperMissing.call(depth0, "link-to", "settings.users", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </section>\n\n        <section class=\"page-actions\">\n\n            \n\n            <button class=\"button-save\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "save", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data})));
  ...
  data.buffer.push(" />\n        <button class=\"edit-cover-image js-modal-cover button\" ");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<a href=\"#\">Make Owner</a>\n<a href=\"#\" class=\"delete\">Delete User</a>");
